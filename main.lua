...
cellinfo = {
	[1  ] = {name="Wall",					desc="Immovable."},
	[2  ] = {name="Pusher",					desc="Constantly attempts to push forwards."},
	[3  ] = {name="Generator",				desc="Pushes out the cell behind it, from the front"},
	...
	[12 ] = {name="Trash",					desc="Deletes all cells that go into it."},
	[13 ] = {name="Enemy",					desc="Deletes a cell that goes into it, then dies."},
	...
	[28 ] = {name="Advancer",				desc="Puller + Pusher."},
	...
	[59 ] = {name="Auger",					desc="Driller + Pusher.\nAttempts to push before drilling."},
	[60 ] = {name="Corkscrew",				desc="Driller + Puller + Pusher."},
	...
	[71 ] = {name="Grasper",				desc="Drags the cells to it's sides along with it."},
	[72 ] = {name="Heaver",					desc="Grasper + Pusher."},
	[73 ] = {name="Lugger",					desc="Puller + Grasper."},
	[74 ] = {name="Hoister",				desc="Puller + Grasper + Pusher."},
	[75 ] = {name="Raker",					desc="Driller + Grasper."},
	[76 ] = {name="Borer",					desc="Grasper + Pusher + Driller."},
	[77 ] = {name="Carrier",				desc="Puller + Grasper + Driller."},
	[78 ] = {name="Omnipower",				desc="Puller + Grasper + Pusher + Driller."},
	[79 ] = {name="Ice",					desc="Causes cells to slip past when they move near it."},
	[80 ] = {name="Octo-Mirror",			desc="4 mirrors combined."},
	[81 ] = {name="CW Grapulsor",			desc="Applies clockwise grasping force to it's neighbors."},
	[82 ] = {name="CCW Grapulsor",			desc="Applies counter-clockwise grasping force to it's neighbors."},
	[83 ] = {name="Bivalve Diverter",		desc="Valve Diverter with three inputs."},
	[84 ] = {name="CW Paravalve Diverter",	desc="Straight Diverter with two extra curved inputs."},
	[85 ] = {name="CCW Paravalve Diverter",	desc="Straight Diverter with two extra curved inputs."},
	[86 ] = {name="Bivalve Displacer",		desc="Bivalve Diverter that doesn't rotate cells."},
	[87 ] = {name="CW Paravalve Displacer",	desc="CW Paravalve Diverter that doesn't rotate cells."},
	[88 ] = {name="CCW Paravalve Displacer",desc="CCW Paravalve Diverter that doesn't rotate cells."},
	[89 ] = {name="Semiflipper A",			desc="Only flips on 2 sides."},
	[90 ] = {name="Semiflipper B",			desc="Only flips on 2 sides."},
	[91 ] = {name="Displacer",				desc="Diverter that doesn't rotate cells."},
	[92 ] = {name="Bidisplacer",			desc="Bidiverter that doesn't rotate cells."},
	[93 ] = {name="CW Valve Diverter",		desc="One-way Diverter with two input faces."},
	[94 ] = {name="CCW Valve Diverter",		desc="One-way Diverter with two input faces."},
	[95 ] = {name="CW Valve Displacer",		desc="CW Valve Diverter that doesn't rotate cells."},
	[96 ] = {name="CCW Valve Displacer",	desc="CCW Valve Diverter that doesn't rotate cells."},
	...
	[119] = {name="Green Marker",			desc="Decoration. Transparent to cells; disappears after being moved onto."},
	[120] = {name="Cyan Marker",			desc="Decoration. Transparent to cells; disappears after being moved onto."},
	[121] = {name="Blue Marker",			desc="Decoration. Transparent to cells; disappears after being moved onto."},
	[122] = {name="Purple Marker",			desc="Decoration. Transparent to cells; disappears after being moved onto."},
	...
	[126] = {name="Hallow",					desc="Immovable. When a cell tries to push it, it turns into a another Hallow."},
	...
	[136] = {name="Clamper",				desc="Prevents cells from being pushed."},
	...
	[147] = {name="Time Generator",			desc="Generates whatever the cell behind it was in the initial state."},
	[148] = {name="Cross Timewarper",		desc="Two Timewarpers in one."},
	[149] = {name="Life",					desc="Spreads like Conway's Game of Life. Infects non-Life cells."},
	[150] = {name="CW Spinner",				desc="Immovable. When a cell touches it, it rotates the cell clockwise."},
	[151] = {name="CCW Spinner",			desc="Immovable. When a cell touches it, it rotates the cell counter-clockwise."},
	[152] = {name="180 Spinner",			desc="Immovable. When a cell touches it, it rotates the cell 180 degrees."},
	...
	[170] = {name="CCW Multigenerator",		desc="Generator that generates two cells at once."},
	...
	[258] = {name="CCW Multishifter",		desc="Shifter that outputs two cells at once."},
	[259] = {name="CW Multishifter",		desc="Shifter that outputs two cells at once."},
	...
	[264] = {name="CCW Multirelocator",		desc="CW Multishifter that doesn't rotate the outputted cell."},
	[265] = {name="CW Multirelocator",		desc="CCW Multishifter that doesn't rotate the outputted cell."},
	...
	[269] = {name="Crasher",				desc="Pusher + Slicer.\nAttempts to push before slicing."},
	[270] = {name="Tugger",					desc="Puller + Slicer."},
	[271] = {name="Yanker",					desc="Puller + Pusher + Slicer."},
	[272] = {name="Lifter",					desc="Grasper + Slicer."},
	[273] = {name="Hauler",					desc="Grasper + Pusher + Slicer."},
	[274] = {name="Dragger",				desc="Puller + Grasper + Slicer."},
	[275] = {name="Mincer",					desc="Puller + Grasper + Pusher + Slicer."},
	[276] = {name="Cutter",					desc="Driller + Slicer.\nAttempts to slice before drilling."},
	[277] = {name="Screwdriver",			desc="Driller + Pusher + Slicer.\nAttempts to push, then slice, then drill."},
	[278] = {name="Piecer",					desc="Driller + Puller + Slicer."},
	[279] = {name="Slasher",				desc="Driller + Puller + Pusher + Slicer."},
	[280] = {name="Chiseler",				desc="Driller + Grasper + Slicer."},
	[281] = {name="Lacerator",				desc="Driller + Grasper + Pusher + Slicer."},
	[282] = {name="Carver",					desc="Driller + Puller + Grasper + Slicer."},
	[283] = {name="Apeiropower",			desc="Driller + Puller + Grasper + Pusher + Slicer."},
	[284] = {name="Super Pusher",			desc="A pusher with infinite force that moves infinitely fast."},
	...
	[288] = {name="Fragile Player",			desc="A player that acts like an enemy."},
	[289] = {name="Puller Player",			desc="A player that pulls."},
	[290] = {name="Grasper Player",			desc="A player that grasps."},
	[291] = {name="Driller Player",			desc="A player that drills."},
	[292] = {name="Nudger Player",			desc="A player that cannot push."},
	[293] = {name="Fragile Puller Player",	desc="A player that pulls and acts like an enemy."},
	[294] = {name="Fragile Grasper Player",	desc="A player that grasps and acts like an enemy."},
	[295] = {name="Fragile Driller Player",	desc="A player that drills and acts like an enemy."},
	[296] = {name="Fragile Nudger Player",	desc="A player that cannot push and acts like an enemy."},
	[297] = {name="Slicer Player",			desc="A player that slices."},
	[298] = {name="Fragile Slicer Player",	desc="A player that slices and acts like an enemy."},
	[299] = {name="Quantum Enemy",			desc="When killed, all Quantum Enemies of the same ID are destroyed as well."},
	...
	randrot = {name="Random Rotation",		desc="Testing tool.\nDisabled", idadded=true},
	select = {name="Select",				desc="Toggles the select tool.", idadded=true},
}
...
function SetSelectedCell(id,b)	--not local so it can call itself
	if type(ModData.onSelect[id]) == "function" then
		return ModData.onSelect[id](b)
	end
...
sound = {}
sound.destroy = love.audio.newSource("destroy.ogg", "static")
sound.unlock = love.audio.newSource("unlock.ogg", "static")
sound.move = love.audio.newSource("move.ogg", "static")
sound.rotate = love.audio.newSource("rotate.ogg", "static")
sound.infect = love.audio.newSource("infect.ogg", "static")
sound.coin = love.audio.newSource("coin.ogg", "static")
sound.beep = love.audio.newSource("beep.wav", "static")
...
music2:setVolume(.5)
music3:setVolume(.5)
sound.destroy:setVolume(.5)
sound.unlock:setVolume(.5)
sound.move:setVolume(2)
sound.rotate:setVolume(.25)
sound.infect:setVolume(1.5)
sound.coin:setVolume(.25)
sound.beep:setVolume(.5)
...
function On(eventName, fn)
	if not eventListeners[eventName] then return end
	table.insert(eventListeners[eventName], fn)
end

function Off(eventName, fn)
	if eventListeners[eventName] then
		for i,v in pairs(eventListeners[eventName]) do
			if v == fn then
...
function OnUpdate(fn) On("update", fn) end
function OnRender(fn) On("render", fn) end
function OnRenderCell(fn) On("render-cell", fn) end
function OnRenderGrid(fn) On("render-grid", fn) end
function OnTick(fn) On("tick", fn) end
function OnSubtick(fn) On("subtick", fn) end
function OnSetInitial(fn) On("set-initial", fn) end
function OnGridReset(fn) On("grid-reset", fn) end
function OnGridClear(fn) On("grid-clear", fn) end
function OnCellPlace(fn) On("cell-place", fn) end
function OnCellSet(fn) On("cell-set", fn) end
function OnKeyPressed(fn) On("keypressed", fn) end

local function TriggerEvent(eventName, ...)
	if eventListeners[eventName] then
		for _,v in pairs(eventListeners[eventName]) do
			v(...)
		end
	end
end

ModData.convertIdMap = {}
ModData.hasVars = {}
ModData.defaultVars = {}
ModData.cellTypes = {}
...
ModData.onClick = {}
ModData.onSelect = {}
ModData.winConditions = {}
ModData.nextCells = {}

function HookTo(fnName, fn)
	local oldFn = _G[fnName]
	_G[fnName] = function(...)
		fn(...)
		return oldFn(...)
	end
...
local loadingMod = nil
local function LoadMods()
	local mods = love.filesystem.getDirectoryItems("OldMods")
	for _, mod in ipairs(mods) do
		if love.filesystem.getInfo("OldMods/" .. mod, "directory") then
			loadingMod = mod
			require("OldMods/" .. mod .. "/main")
		end
	end
	loadingMod = nil
end

local function moderr(msg)
	if loadingMod ~= nil then
		msg = "Mod Error (" .. loadingMod .. "): " .. msg
	else
		msg = "Mod Error: " .. msg
	end
...
function Toolbar.GetCategory(name)
...
function Toolbar.AddCategory(category, index)
	if index == nil then
...
function CreateCategory(title, description, max, cells, icon)
	max = max or 4
	cells = cells or {}
...
function CreateCell(title, description, texture, options)
	...
	if type(id) ~= "string" then
		moderr("Must specify id for cell (has to be a string)")
	end
	if type(title) ~= "string" then
		moderr("Must specify title for cell")
	end
	if type(description) ~= "string" then
		moderr("Must specify description for cell")
	end
	if type(texture) ~= "string" then
		moderr("Must specify texture for cell")
	end
	...
	ModData.convertIdMap[id] = options.convertId
	ModData.hasVars[id] = options.hasVars
	ModData.defaultVars[id] = options.defaultVars
	ModData.cellTypes[id] = options.type

	ModData.unbreakable[id] = options.isUnbreakable
	ModData.nonexistant[id] = options.isNonexistant
	ModData.destroyer[id] = options.isDestroyer
	ModData.acidic[id] = options.isAcidic
	ModData.transparent[id] = options.isTransparent
	ModData.toGenerate[id] = options.toGenerate
	ModData.stopOptimization[id] = options.stopsOptimization

	ModData.onRotate[id] = options.onRotate
	ModData.onFlip[id] = options.onFlip
	ModData.flipCell[id] = options.flip

	ModData.push[id] = options.push
	ModData.onClick[id] = options.onClick
	ModData.onSelect[id] = options.onSelect
	ModData.nextCells[id] = options.nextCell

	-- mostly copied from cellmod lol
...
function AddWinCondition(fn)
	table.insert(ModData.winConditions, fn)
end

local randchars = {} do -- [0-9a-zA-Z]
	for c = 48, 57  do table.insert(randchars, string.char(c)) end
	for c = 65, 90  do table.insert(randchars, string.char(c)) end
	for c = 97, 122 do table.insert(randchars, string.char(c)) end
end
local function randStr(length)
	if not length or length <= 0 then return "" end
	math.randomseed(os.clock()^5)
	return randStr(length - 1) .. randchars[math.random(1, #randchars)]
end

function Symbol(name, security)
	security = security or 16
	if security < 4 then moderr("Symbol security too low") end
	return "__sym__" .. randStr(security) .. "__" .. name
end

local savestore = {}
function Savestore(symbol, table)
	savestore[symbol] = savestore[symbol] or {}
	if getmetatable(savestore[symbol]) == nil then setmetatable({ __mode = "k" }) end
	savestore[symbol][table] = savestore[symbol][table] or {}
	return savestore[symbol][table]
end

Modchine = {}
Modchine.version = "1.0-beta5"
Modchine.moddata = ModData
Modchine.mods = {}
...
---@field minModchineVersion string

---@param data ModchineMod
function Modchine.mod(data)
	Modchine.mods[data.name] = data
	loadingMod = data.name

	if data.minModchineVersion then
		Modchine.requireVersion(data.minModchineVersion)
	end
end

--- compares versions like "1.0.0" and "1.2-beta4"
function Modchine.compareVersion(v1, v2)
	local v1parts = {}
	local v2parts = {}
	...
	local v1suffix = v1:gmatch("-beta(.+)$")()
	local v2suffix = v2:gmatch("-beta(.+)$")()
	...
	if v1suffix and not v2suffix then
		return -1
	elseif not v1suffix and v2suffix then
		return 1
	end

	if v1suffix and v2suffix then
		return Modchine.compareVersion(v1suffix, v2suffix)
	end
...
function ConvertId(id)
	if ModData.convertIdMap[id] ~= nil then
		return ModData.convertIdMap[id]
	end
...
function CopyVars(id)
	return id == 206 or id == 221 or id == 224 or id == 299 or ModData.hasVars[id] == true
end
...
function IsBackground(id)
	return id == "placeable"
		...
		or id == "placeableP"
		or id == "rotatable"
		or ModData.cellTypes[id] == "background"
end
...
function DefaultVars(id)	--Default variables.
	...
	elseif ModData.defaultVars[id] ~= nil then return ModData.defaultVars[id]
	else return {} end
end
...
function PlaceCell(x,y,cell)
	...
	if x > 0 and x < width-1 and y > 0 and y < height-1 then
		...
		SetChunk(x,y,cell)
		TriggerEvent("cell-place", cell, x, y, was)
		return true
	end
end
...
function SetCell(x,y,cell)
	...
	if x > 0 and x < width-1 and y > 0 and y < height-1 then
		...
		cells[y][x] = cell
		if cell.id == 221 or was == 221 then
			ResetPortals()
		end
		TriggerEvent("cell-set", cell, x, y, was)
		SetChunk(x,y,cell)
	end
end
...
NewButton(150,100,40,40,"delete","tomainmenu","Back to Main Menu",nil,function() mainmenu = 1; puzzle = true; inmenu = false; PlaySound(sound.beep) end,false,bactive,"center",nil,{1,.5,.5,.5},{1,.5,.5,1},{.5,.25,.25,1})
...
NewButton(-120,100,60,60,"puzzle","puzzlescreen","Puzzles",nil,function() mainmenu = 2; delay = .2; tpu = 1; PlaySound(sound.beep) end,false,mmenu1,"center")
...
NewButton(120,100,60,60,2,"startgamebtn","Sandbox",nil,function() mainmenu = false; newwidth = 100; newheight = 100; border = 2; delay = .2; tpu = 1; title,subtitle = "",""; ClearWorld(); puzzle = false; level = nil ResetCam() PlaySound(sound.beep) end,false,mmenu1,"center")
...
function ToDir(rot,side)	--laziness (converts rotation of cell & side of cell -> the direction the force is going to)
	return (rot+side+2)%4
end
...
function IsDestroyer(cell,dir,x,y,vars)
	...
	if type(ModData.destroyer[id]) == "function" then
		return ModData.destroyer[id](cell, dir, x, y, vars)
	end
...
function IsTransparent(cell,dir,x,y,vars)
	if type(ModData.transparent[cell.id]) == "function" then
		return ModData.transparent[cell.id](cell, dir, x, y, vars)
	end
...
function ToGenerate(cell,dir,x,y)
	...
	local rot = cell.rot
	local side = ToSide(rot,dir)
	if type(ModData.toGenerate[cell.id]) == "function" then
		return ModData.toGenerate[cell.id](cell, dir, x, y, side)
	end
	if id == 20 then
		return getempty()
...
function NextCell(x,y,dir,lastcell,reversed,checkfirst,determinative)	--i know it's a weirdly named function
	...
	while true do
		if checkfirst or not firstloop then
			...
			if type(ModData.nextCells[id]) == "function" then
				vars.lastcell = lastcell
				vars.reversed = reversed
				vars.determinative = determinative
				local odir, ox, oy = dir, x, y
				dir, x, y = ModData.nextCells[id](x, y, dir, side, vars)
...
function RotateCell(x,y,rot,dir,large)
	...
	if type(ModData.onRotate[cell.id]) == "function" then
		ModData.onRotate[cell.id](cell, x, y, dir, rot)
	end
end
...
function FlipCellRaw(cell,rot)
	...
	if type(ModData.flipCell[cell.id]) == "function" then
		return ModData.flipCell[cell.id](cell, rot)
	end
...
function FlipCell(x,y,rot,dir)
	...
	if type(ModData.onFlip[cell.id]) == "function" then
		ModData.onFlip[cell.id](x,y,rot,dir)
	end
end
...
function HandleNudge(cell,dir,x,y,vars)
	...
	local rot = cell.rot
	local side = ToSide(rot,dir)
	if type(ModData.push[cell.id]) == "function" then
		ModData.push[cell.id](cell, dir, x, y, vars, side, 1, "nudge")
	end
...
function HandlePush(force,cell,dir,x,y,vars)
	...
	if type(ModData.push[cell.id]) == "function" then
		local p = ModData.push[cell.id](cell, dir, x, y, vars, side, force + gfactor, "push")
...
function HandleGrasp(force,cell,dir,x,y,vars)
	...
	if cell.sealed then
		vars.ended = true
		return force
	elseif type(ModData.push[cell.id]) == "function" then
		local p = ModData.push[cell.id](cell, dir, x, y, vars, side, force, "grab")
...
function HandlePull(force,cell,dir,x,y,vars)
	...
	local side = ToSide(rot,dir)
	if type(ModData.push[cell.id]) == "function" then
		local p = ModData.push[cell.id](cell, dir, x, y, vars, side, force, "pull")
		if p == true then return force end
		if p == false then return 0 end
		if type(p) == "number" then return p end
	end
...
function HandleSwap(cell,dir,x,y,vars)
	...
	local side = ToSide(rot,dir)
	if type(ModData.push[cell.id]) == "function" then
		ModData.push[cell.id](cell, dir, x, y, vars, side, 1, "swap")
	end
...
function PullCell(x,y,dir,vars)
	...
	if dir == 0 then x = x-1 elseif dir == 2 then x = x+1
	elseif dir == 1 then y = y-1 elseif dir == 3 then y = y+1 end
	if GetCell(x,y) ~= oldcell or vars.dontfailonfirst or IsNonexistant(oldcell,dir,x,y,vars) then PlaySound(sound.move) return true end
	return false
end
...
function CheckEnemies()
	if puzzle then
		...
		for _,cond in pairs(ModData.winConditions) do
...
function DoTick(first)
	...
	if subticking then
		...
		repeat
			...
			TriggerEvent("subtick", subtick)
		until subticks[subtick]() or subtick == #subticks
		if subtick == #subticks then subtick = 0 TriggerEvent("tick", first) end
	else
		ResetCells(first)
		for i=subtick%#subticks+1,#subticks do
			TriggerEvent("subtick", i)
			subticks[i]()
		end
		subtick = 0
		TriggerEvent("tick", first)
	end
	held = nil
	isinitial = false
	dtime = 0
...
function DrawCell(cell,x,y,ip)
	...
	if cell.id ~= 0 then
		...
		TriggerEvent("render-cell", cell, x, y, ip)
	end
...
function love.draw()
	...
	elseif mainmenu == 4 then
		...
		love.graphics.draw(menuparticles,centerx,centery)
		love.graphics.setColor(0,0,0,1)
		local t = "Drop mod .zip file here!\nblame love2d for not working"
		love.graphics.printf(t,centerx+uiscale,centery,400,"center",0,uiscale*2,uiscale*2,200)
		love.graphics.setColor(1,1,1,1)
		love.graphics.printf(t,centerx,centery,400,"center",0,uiscale*2,uiscale*2,200)
	end
	...
	if btn == 1 and not hoveredbutton and not IsBackground(chosen.id) then
		...
		if puzzle then
			if isinitial then
				...
				if type(ModData.onClick[p]) == "function" then
					ModData.onClick[p](cells[cy][cx], cx, cy)
				end
			end
		elseif pasting then
			undocells.topush = table.copy(cells)
...
function love.filedropped(file)
	...
	-- 	local name = extractZIP(filename, "Mods")
	-- 	require("Mods/" .. name .. "/main")
	-- 	mainmenu = 1
	-- end
end
